...
import 'usecase_vendor_create.dart';

@Injectable(as: UsecaseVendorCreate)
class UsecaseVendorCreateImpl extends UsecaseVendorCreate {
  UsecaseVendorCreateImpl(this.applicationRepository, this.authRepository, this.mapper);
