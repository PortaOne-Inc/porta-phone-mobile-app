...
mixin _$CapabilitiesState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is CapabilitiesState);
  }
...
class $CapabilitiesStateCopyWith<$Res> {
  $CapabilitiesStateCopyWith(
      CapabilitiesState _, $Res Function(CapabilitiesState) __);
}
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case _Loading() when loading != null:
        return loading();
      case _Ready() when ready != null:
        return ready(_that.capabilities, _that.dirty, _that.query);
      case _Failure() when failure != null:
