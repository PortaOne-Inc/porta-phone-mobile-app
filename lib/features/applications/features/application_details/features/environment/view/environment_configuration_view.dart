                          ...
                          children: [
                            ConfigSection(
                              ...
                              fields: [
                                ...
                                ConfigField(
                                  key: ValueKey(state.appGreetingKeyName + state.status.name),
                                  label: 'App Greeting',
                                ...
                                ConfigField(
                                  key: ValueKey(state.appAboutUrlKeyName + state.status.name),
                                  label: 'App About URL',
                                ...
                                ConfigField(
                                  key: ValueKey(state.appCredentialsRequestUrlKeyName + state.status.name),
                                ...
                                ConfigField(
                                  key: ValueKey(state.salesEmailKeyName + state.status.name),
                                  label: 'Sales Email',
                            ...
                            ConfigSection(
                              ...
                              fields: [
                                ...
                                ConfigField(
                                  key: ValueKey(state.enableAttendedTransferKeyName + state.status.name),
                            ...
                            ConfigSection(
                              ...
                              fields: [
                                ConfigField(
                                  key: ValueKey(state.fcmVapidKeyKeyName + state.status.name),
                                  label: 'FCM VAPID Key',
                            ...
                            ConfigSection(
                              ...
                              fields: [
                                ...
                                ConfigField(
                                  key: ValueKey(state.remoteLogzioLogLevelKeyName + state.status.name),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ConfigSection(
                              ...
                              fields: [
                                ConfigField(
                                  key: ValueKey(state.callTriggerMechanismSmsKeyName + state.status.name),
                                ...
                                ConfigField(
                                  key: ValueKey(state.callTriggerMechanismSmsPrefixKeyName + state.status.name),
                                  label: 'SMS Prefix',
                                  keyName: state.callTriggerMechanismSmsPrefixKeyName,
                                  config: state.environment,
                                  onConfigUpdate: _updateConfig,
                                  onEnabledChanged: _manageKey,
                                ),
                                ConfigField(
                                  key: ValueKey(state.callTriggerMechanismSmsRegexPatternKeyName + state.status.name),
                                  label: 'SMS Regex Pattern',
                                  keyName: state.callTriggerMechanismSmsRegexPatternKeyName,
                                  config: state.environment,
                                  onConfigUpdate: _updateConfig,
                                  onEnabledChanged: _manageKey,
                                ),
                            ...
                            ConfigSection(
                              ...
                              fields: [
                                ConfigField(
                                  key: ValueKey(state.connectivityCheckUrlKeyName + state.status.name),
                            ...
                            ConfigSection(
                              ...
                              fields: [
                                ConfigField(
                                  key: ValueKey(state.userRepositoryPollingIntervalSecondsKeyName + state.status.name),
                                  label: 'User Repository',
                                  keyName: state.userRepositoryPollingIntervalSecondsKeyName,
                                  config: state.environment,
                                  defaultValue: 10,
                                  onConfigUpdate: _updateConfig,
                                  onEnabledChanged: _manageKey,
                                ...
                                ConfigField(
                                  key: ValueKey(
                                      state.systemInfoRepositoryPollingIntervalSecondsKeyName + state.status.name),
                                  label: 'System Info Repository',
                                  keyName: state.systemInfoRepositoryPollingIntervalSecondsKeyName,
                                  config: state.environment,
                                  defaultValue: 300,
                                  onConfigUpdate: _updateConfig,
                                  onEnabledChanged: _manageKey,
                                ...
                                ConfigField(
                                  ...
                                  keyName: state.externalContactsRepositoryPollingIntervalSecondsKeyName,
                                  config: state.environment,
                                  defaultValue: 60,
                                  onConfigUpdate: _updateConfig,
                                  onEnabledChanged: _manageKey,
                                ...
                                ConfigField(
                                  key: ValueKey(
                                      state.voicemailRepositoryPollingIntervalSecondsKeyName + state.status.name),
                                  label: 'Voicemail Repository',
                                  keyName: state.voicemailRepositoryPollingIntervalSecondsKeyName,
                                  config: state.environment,
                                  defaultValue: 300,
                                  onConfigUpdate: _updateConfig,
                                  onEnabledChanged: _manageKey,
                                ...
                                ConfigField(
                                  ...
                                  keyName: state.callerIdSettingsRepositoryPollingIntervalSecondsKeyName,
                                  config: state.environment,
                                  defaultValue: 300,
                                  onConfigUpdate: _updateConfig,
                                  onEnabledChanged: _manageKey,
