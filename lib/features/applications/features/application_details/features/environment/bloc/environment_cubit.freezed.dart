...
class _$EnvironmentStateImpl extends _EnvironmentState {
  _$EnvironmentStateImpl(
...
abstract class _EnvironmentState extends EnvironmentState {
  factory _EnvironmentState(
      {required final String applicationId,
      final EnvironmentStatus status,
      final Map<String, dynamic> environment,
      final String? errorMessage}) = _$EnvironmentStateImpl;
  _EnvironmentState._() : super._();
