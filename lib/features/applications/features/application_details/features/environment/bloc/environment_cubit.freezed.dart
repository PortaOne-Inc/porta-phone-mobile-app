...
mixin _$EnvironmentState {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, applicationId, status,
      const DeepCollectionEquality().hash(environment), errorMessage);
...
extension EnvironmentStatePatterns on EnvironmentState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String applicationId, EnvironmentStatus status,
            Map<String, dynamic> environment, String? errorMessage)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _EnvironmentState() when $default != null:
        return $default(_that.applicationId, _that.status, _that.environment,
            _that.errorMessage);
      case _:
        return orElse();
    }
...
class _EnvironmentState extends EnvironmentState {
  _EnvironmentState(
      ...
      final Map<String, dynamic> environment = const {},
      this.errorMessage})
  ...
  @override
  int get hashCode => Object.hash(runtimeType, applicationId, status,
      const DeepCollectionEquality().hash(_environment), errorMessage);
