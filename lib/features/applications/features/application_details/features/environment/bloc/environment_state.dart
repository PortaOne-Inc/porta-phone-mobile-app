...
sealed class EnvironmentState with _$EnvironmentState {
  ...
  Map<String, dynamic> get filteredEnvironment {
    ...
    return Map<String, dynamic>.from(environment)
  ...
  String get appCredentialsRequestUrlKeyName =>
      'WEBTRIT_APP_CREDENTIALS_REQUEST_URL';

  String get salesEmailKeyName => 'WEBTRIT_APP_SALES_EMAIL';

  String get coreUrlKeyName => 'WEBTRIT_APP_CORE_URL';

  String get enableAttendedTransferKeyName =>
      'WEBTRIT_APP_ENABLE_ATTENDED_TRANSFER';

  String get demoCoreUrlKeyName => 'WEBTRIT_APP_DEMO_CORE_URL';

  String get coreVersionConstraintKeyName =>
      'WEBTRIT_APP_CORE_VERSION_CONSTRAINT';

  String get fcmVapidKeyKeyName => 'WEBTRIT_APP_FCM_VAPID_KEY';

  String get remoteLogzioLoggingUrlKeyName =>
      'WEBTRIT_APP_REMOTE_LOGZIO_LOGGING_URL';

  String get remoteLogzioLogLevelKeyName =>
      'WEBTRIT_APP_REMOTE_LOGZIO_LOG_LEVEL';

  String get remoteLogzioLoggingTokenKeyName =>
      'WEBTRIT_APP_REMOTE_LOGZIO_LOGGING_TOKEN';

  String get remoteLogzioLoggingBufferSizeKeyName =>
      'WEBTRIT_APP_REMOTE_LOGZIO_LOGGING_BUFFER_SIZE';

  String get callTriggerMechanismSmsKeyName =>
      'WEBTRIT_CALL_TRIGGER_MECHANISM_SMS';

  String get callTriggerMechanismSmsPrefixKeyName =>
      'WEBTRIT_CALL_TRIGGER_MECHANISM_SMS_PREFIX';

  String get callTriggerMechanismSmsRegexPatternKeyName =>
      'WEBTRIT_CALL_TRIGGER_MECHANISM_SMS_REGEX_PATTERN';

  String get connectivityCheckUrlKeyName =>
      'WEBTRIT_APP_CONNECTIVITY_CHECK_URL';
  ...
  String get userRepositoryPollingIntervalSecondsKeyName =>
      'WEBTRIT_APP_USER_REPOSITORY_POLLING_INTERVAL_SECONDS';
