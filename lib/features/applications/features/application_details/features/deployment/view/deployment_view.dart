                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              GroupTitleTile(
                                titleData: context
                                    .l10n.feature_application_details_ApplicationDetailsScreen_android_build_name,
                              ...
                              ListTile(
                                title: Text(context
                                    .l10n.feature_application_details_ApplicationDetailsScreen_android_platform_id),
                              ...
                              ListTile(
                                ...
                                subtitle: SelectableText(state.application?.appVersion?.buildName ??
                              ...
                              ListTile(
                                title: Text(context
                                    .l10n.feature_application_details_ApplicationDetailsScreen_android_build_number),
                                subtitle:
                                    SelectableText(state.application?.androidVersion?.buildNumber?.toString() ?? ''),
                                minLeadingWidth: 4,
                                trailing: Builder(
                                  builder: (context) {
                                    const platform = BuildPlatform.android;
                    ...
                    children: [
                      ...
                      GroupTitleTile(
                        ...
                        trailing: ElevatedButton(
                          onPressed: state.applicationDeploy.anyDeployPlatformAvailable &&
                      ...
                      ListTile(
                        ...
                        subtitle: Wrap(spacing: 8, runSpacing: 16, children: [
                          PlatformCheckbox(
                            ...
                            onTap: (deploy) => deploymentCubit.updateApplicationDeploy(state.applicationDeploy.copyWith(
                              android: state.applicationDeploy.android.copyWith(deploy: deploy),
                            )),
                          ),
                          PlatformCheckbox(
                            ...
                            onTap: (deploy) => deploymentCubit.updateApplicationDeploy(state.applicationDeploy.copyWith(
                              ios: state.applicationDeploy.ios.copyWith(deploy: deploy),
                            )),
                          ),
                        ]),
                      ),
                      if (state.applicationDeploy.isAndroidPlatformSelected)
                        Padding(
                          ...
                          child: ExpansionTile(
                            title: Text(context
                                .l10n.feature_application_details_ApplicationDetailsScreen_android_configuration),
                            ...
                            children: <Widget>[
                              PlayStoreConfigForm(
                                track: state.applicationDeploy.android.playStoreConfig.track,
                                availableTrack: state.applicationDeploy.android.playStoreConfig.availableTracks,
                                status: state.applicationDeploy.android.playStoreConfig.status,
                                availableStatuses: state.applicationDeploy.android.playStoreConfig.availableStatuses,
                                updatePriority: state.applicationDeploy.android.playStoreConfig.updatePriority,
                                userFraction: state.applicationDeploy.android.playStoreConfig.userFraction,
                                userFractionAvailability:
                      ...
                      BranchSelector(
                        ...
                        initialBranch: state.applicationDeploy.applicationDependencyBranches.phoneSourceBranch,
                        branches: state.applicationDeploy.applicationDependencyBranches.phoneBranches
                            .map((it) => it.name)
                            .toList(),
                        onUpdate: (value) => deploymentCubit.updateApplicationDeploy(
                          state.applicationDeploy.copyWith(
                            applicationDependencyBranches:
                                state.applicationDeploy.applicationDependencyBranches.copyWith(
                        ...
                        subtitle: ExpansionTile(
                          ...
                          children: <Widget>[
                            ...
                            BranchSelector(
                              ...
                              initialBranch:
                                  state.applicationDeploy.applicationDependencyBranches.configuratorSourceBranch,
                              branches:
                                  state.applicationDeploy.applicationDependencyBranches.defaultConfiguratorBranches,
                              onUpdate: (value) => deploymentCubit.updateApplicationDeploy(
                                state.applicationDeploy.copyWith(
                                  applicationDependencyBranches: state.applicationDeploy.applicationDependencyBranches
                                      .copyWith(configuratorSourceBranch: value),
                                ),
                              ),
                            ),
                            BranchSelector(
                              ...
                              initialBranch: state
                                  .applicationDeploy.applicationDependencyBranches.phoneConfiguratorToolSourceBranch,
                              branches: state
                                  .applicationDeploy.applicationDependencyBranches.defaultPhoneConfiguratorToolBranches,
                              onUpdate: (value) => deploymentCubit.updateApplicationDeploy(
                                state.applicationDeploy.copyWith(
                                  applicationDependencyBranches:
                                      state.applicationDeploy.applicationDependencyBranches.copyWith(
                            ...
                            BranchSelector(
                              title: context
                                  .l10n.feature_application_details_ApplicationDetailsScreen_enter_branch_for_keystore,
                              initialBranch: state.applicationDeploy.applicationDependencyBranches.keystoreSourceBranch,
                              branches: state.applicationDeploy.applicationDependencyBranches.defaultKeystoreBranches,
                              onUpdate: (value) => deploymentCubit.updateApplicationDeploy(
                                state.applicationDeploy.copyWith(
                                  applicationDependencyBranches:
                                      state.applicationDeploy.applicationDependencyBranches.copyWith(
