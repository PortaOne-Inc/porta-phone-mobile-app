        ...
        children: [
          ...
          ListTile(
            ...
            trailing: InkWell(
              child: Visibility(
                ...
                child: Row(
                  ...
                  children: [
                    Text('Open', style: textTheme.bodyMedium?.copyWith(color: colorScheme.primary)),
                    const SizedBox(width: 8),
                    Icon(Icons.open_in_new_outlined, color: colorScheme.primary),
                  ],
                ),
              ),
            ...
            subtitle: application?.theme != null
                ...
                : Text('Not selected default theme yet', style: textTheme.bodySmall),
            minLeadingWidth: 4,
            leading: Container(
              width: 8,
              color: colorScheme.primary.withValues(alpha: 0.2),
          ...
          ListTile(
            ...
            title: Text(
              'Deploy applications',
              style: textTheme.titleMedium?.copyWith(color: colorScheme.surfaceTint, fontWeight: FontWeight.w500),
            ),
            subtitle: Text(
              'Deploy applications to the Play Store and App Store.',
              style: textTheme.bodyMedium?.copyWith(color: colorScheme.surfaceTint),
            ),
            trailing: Icon(Icons.keyboard_arrow_right, color: colorScheme.surfaceTint),
            onTap: onDeploy,
          ),
          Divider(thickness: 4, color: colorScheme.surfaceContainerLow),
          ListTile(
            leading: Icon(Icons.line_weight_rounded, color: colorScheme.primary),
            title: Text('Dart define build Environment', style: textTheme.titleMedium),
            subtitle: Text('Set up and configure build environments.', style: textTheme.bodySmall),
            trailing: const Icon(Icons.keyboard_arrow_right),
            onTap: onEnvironment,
          ),
          ListTile(
            leading: Icon(Icons.image_search_outlined, color: colorScheme.primary),
            title: Text('Assets', style: textTheme.titleMedium),
            subtitle: Text('List of application assets (icons, splash screens, etc.)', style: textTheme.bodySmall),
            trailing: const Icon(Icons.keyboard_arrow_right),
            onTap: onAssets,
          ),
          ListTile(
            ...
            subtitle: Text('List of application embeds (third-party integrations, etc.)', style: textTheme.bodySmall),
            trailing: const Icon(Icons.keyboard_arrow_right),
            onTap: onEmbeds,
          ),
          ListTile(
            leading: Icon(Icons.new_releases, color: colorScheme.primary),
            title: Text('Publication resources', style: textTheme.titleMedium),
            subtitle: Text('Resources for help release builds', style: textTheme.bodySmall),
            trailing: const Icon(Icons.keyboard_arrow_right),
          ...
          ListTile(
            enabled: false,
            leading: Icon(Icons.record_voice_over_rounded, color: colorScheme.primary),
