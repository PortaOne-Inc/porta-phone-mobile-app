...
mixin _$ApplicationCollectionState {
  ...
  $ApplicationCollectionStateCopyWith<ApplicationCollectionState>
      get copyWith =>
          _$ApplicationCollectionStateCopyWithImpl<ApplicationCollectionState>(
              this as ApplicationCollectionState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ApplicationCollectionState &&
...
abstract mixin class $ApplicationCollectionStateCopyWith<$Res> {
  factory $ApplicationCollectionStateCopyWith(ApplicationCollectionState value,
          $Res Function(ApplicationCollectionState) _then) =
      _$ApplicationCollectionStateCopyWithImpl;
  @useResult
  $Res call(
...
extension ApplicationCollectionStatePatterns on ApplicationCollectionState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(ApplicationCollectionStateInitial value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case ApplicationCollectionStateInitial() when $default != null:
        return $default(_that.status, _that.user, _that.applications,
            _that.deleteApplication, _that.error);
      case _:
        return orElse();
    }
  }
...
class ApplicationCollectionStateInitial extends ApplicationCollectionState {
  const ApplicationCollectionStateInitial(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ApplicationCollectionStateInitialCopyWith<ApplicationCollectionStateInitial>
      get copyWith => _$ApplicationCollectionStateInitialCopyWithImpl<
          ApplicationCollectionStateInitial>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ApplicationCollectionStateInitial &&
            (identical(other.status, status) || other.status == status) &&
            (identical(other.user, user) || other.user == user) &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class $ApplicationCollectionStateInitialCopyWith<$Res>
    implements $ApplicationCollectionStateCopyWith<$Res> {
  factory $ApplicationCollectionStateInitialCopyWith(
          ApplicationCollectionStateInitial value,
          $Res Function(ApplicationCollectionStateInitial) _then) =
      _$ApplicationCollectionStateInitialCopyWithImpl;
  @override
  @useResult
  $Res call(
      {ApplicationsStateStatus status,
