...
mixin _$ApplicationBuildVersionProgress {
  ...
  $ApplicationBuildVersionProgressCopyWith<ApplicationBuildVersionProgress>
      get copyWith => _$ApplicationBuildVersionProgressCopyWithImpl<
              ApplicationBuildVersionProgress>(
          this as ApplicationBuildVersionProgress, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ApplicationBuildVersionProgress &&
            const DeepCollectionEquality()
                .equals(other.progressNameUpdating, progressNameUpdating) &&
            const DeepCollectionEquality()
                .equals(other.progressNumberUpdating, progressNumberUpdating));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(progressNameUpdating),
      const DeepCollectionEquality().hash(progressNumberUpdating));
...
abstract mixin class $ApplicationBuildVersionProgressCopyWith<$Res> {
  factory $ApplicationBuildVersionProgressCopyWith(
          ...
          $Res Function(ApplicationBuildVersionProgress) _then) =
      _$ApplicationBuildVersionProgressCopyWithImpl;
  @useResult
  $Res call(
...
extension ApplicationBuildVersionProgressPatterns
    on ApplicationBuildVersionProgress {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ApplicationBuildVersionProgress value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<BuildPlatform> progressNameUpdating,
            List<BuildPlatform> progressNumberUpdating)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ApplicationBuildVersionProgress() when $default != null:
        return $default(
            _that.progressNameUpdating, _that.progressNumberUpdating);
      case _:
        return orElse();
    }
  }
...
class _ApplicationBuildVersionProgress extends ApplicationBuildVersionProgress {
  const _ApplicationBuildVersionProgress(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ApplicationBuildVersionProgressCopyWith<_ApplicationBuildVersionProgress>
      get copyWith => __$ApplicationBuildVersionProgressCopyWithImpl<
          _ApplicationBuildVersionProgress>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ApplicationBuildVersionProgress &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$ApplicationBuildVersionProgressCopyWith<$Res>
    implements $ApplicationBuildVersionProgressCopyWith<$Res> {
  factory _$ApplicationBuildVersionProgressCopyWith(
          _ApplicationBuildVersionProgress value,
          $Res Function(_ApplicationBuildVersionProgress) _then) =
      __$ApplicationBuildVersionProgressCopyWithImpl;
  @override
  @useResult
  $Res call(
      {List<BuildPlatform> progressNameUpdating,
...
class __$ApplicationBuildVersionProgressCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_ApplicationBuildVersionProgress(
      progressNameUpdating: null == progressNameUpdating
          ? _self._progressNameUpdating
          : progressNameUpdating // ignore: cast_nullable_to_non_nullable
              as List<BuildPlatform>,
      progressNumberUpdating: null == progressNumberUpdating
          ? _self._progressNumberUpdating
          : progressNumberUpdating // ignore: cast_nullable_to_non_nullable
              as List<BuildPlatform>,
    ));
  }
