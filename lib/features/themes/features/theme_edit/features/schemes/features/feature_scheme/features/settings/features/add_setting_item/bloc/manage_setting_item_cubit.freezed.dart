...
mixin _$ManageSettingItemState {
  ...
  $ManageSettingItemStateCopyWith<ManageSettingItemState> get copyWith =>
      _$ManageSettingItemStateCopyWithImpl<ManageSettingItemState>(
          this as ManageSettingItemState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ManageSettingItemState &&
...
abstract mixin class $ManageSettingItemStateCopyWith<$Res> {
  factory $ManageSettingItemStateCopyWith(ManageSettingItemState value,
          $Res Function(ManageSettingItemState) _then) =
      _$ManageSettingItemStateCopyWithImpl;
  @useResult
  $Res call(
      {bool enable,
      String? titleL10n,
...
class _$ManageSettingItemStateCopyWithImpl<$Res>
  ...
  $EmbeddedResourceModelCopyWith<$Res>? get selectedEmbeddedResource {
    ...
    return $EmbeddedResourceModelCopyWith<$Res>(_self.selectedEmbeddedResource!,
        (value) {
  ...
  $AppConfigSettingsItemCopyWith<$Res>? get resultSettingItem {
    ...
    return $AppConfigSettingsItemCopyWith<$Res>(_self.resultSettingItem!,
        (value) {
