    ...
    return ListView(
      ...
      children: [
        ThemeOverrideSelector(
          ...
          onChanged: (v) {
            context.read<UpdateThemCubit>().add(ThemePageEvent.setEmbeddedPage(config.copyWith(themeOverride: v)));
          },
        ),
        ...
        PageBackgroundEditor(
          ...
          onChanged: (v) {
            context.read<UpdateThemCubit>().add(ThemePageEvent.setEmbeddedPage(config.copyWith(background: v)));
          },
        ),
      ],
    );
