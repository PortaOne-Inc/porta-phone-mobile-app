...
//
//   @override
//   State<LaunchAssetsConfigurationView> createState() => _LaunchAssetsConfigurationViewState();
// }
//
// class _LaunchAssetsConfigurationViewState extends State<LaunchAssetsConfigurationView> with MixinMessages {
...
//
//   late final bloc = BlocProvider.of<UpdateThemCubit>(context);
//
//   @override
...
//                   const Text('Select file a resource for forming system picture'),
//                 ],
//               ),
//               const SizedBox(
//                 height: 8,
...
//                         value: _launchIconsFitBox,
//                         onChanged: (fit) => setState(() => _launchIconsFitBox = fit ?? _launchIconsFitBox),
...
//     _assetModel = await GoRouter.of(context).pushNamed<ThemeAssetModel>(
