...
List<DesignerPageConfig> buildDesignerPages({
  ...
  return <DesignerPageConfig>[
    DesignerPageConfig(
      ...
      safeZoneDp: cons.androidAdaptive?.safeZoneDp,
      maskDp: cons.androidAdaptive?.toleranceDp,
      exportSizePx: 0,
    ...
    DesignerPageConfig(
      ...
      maskDp: cons.androidLegacy?.toleranceDp,
      exportSizePx: 512,
