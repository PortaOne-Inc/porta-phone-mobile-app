...
class ResetPasswordState with _$ResetPasswordState {
  ...
  factory ResetPasswordState.progress({
    AuthEmailInput? emailInput,
  ...
  factory ResetPasswordState.validation({
    AuthEmailInput? emailInput,
...
extension _StateCopyWith on ResetPasswordState {
  ResetPasswordState copyWithValidate({
    AuthEmailInput? emailInput,
  }) {
  ...
  ResetPasswordState copyWithProgress({
    AuthEmailInput? emailInput,
  }) {
  ...
  ResetPasswordState copyWithSuccess({
    AuthEmailInput? emailInput,
  }) {
