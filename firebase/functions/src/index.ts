...
router.post('/users/:userId/applications/:applicationId', parseAuthToken, validateCreateApplication, (req, res) => createApplication(req, res));
router.get('/users/:userId/applications/:applicationId/themes', (req, res) => getThemes(req, res));
router.post('users/:userId/applications/:applicationId/themes', parseAuthToken, validateCreateTheme, (req, res) => createTheme(req, res));
