...
iOS implementation of [`signaling_service`](../signaling_service/README.md).
...
(from `signaling_service_platform_interface`). All connection logic lives there:
...
| Package                                                                                                     | Description                                               |
|-------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|
| [`signaling_service_platform_interface`](../signaling_service_platform_interface/README.md) | Shared interface and `WebtritSignalingServiceDirect` base |
| [`signaling_service`](../signaling_service/README.md)                                       | Public API aggregator                                     |
| [`signaling_service_android`](../signaling_service_android/README.md)                       | Android implementation                                    |
