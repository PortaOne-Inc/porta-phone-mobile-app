...
void main() {
  ...
  patrolTest('the contacts sync worker drives every contact flow', ($) async {
    ...
    final offlineAt = await withNetworkDisabled($, () => _pullWhileOffline($));
...
void _expectFreshSession(PatrolIntegrationTester $) {
  expect(
...
Future<DateTime> _pullWhileOffline(PatrolIntegrationTester $) async {
