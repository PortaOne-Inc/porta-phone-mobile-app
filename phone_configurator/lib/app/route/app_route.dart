      ...
      routes: [
        GoRoute(
          ...
          builder: (BuildContext context, GoRouterState state) {
            final token = state.pathParameters[AppRoutInfo.keyShareToken]!;
            return BlocProvider<SharedPreviewCubit>(
              create: (_) => SharedPreviewCubit(token: token, getSharedThemePreviewUsecase: getIt.get()),
          ...
          routes: [
            ...
            GoRoute(
              ...
              builder: (BuildContext context, GoRouterState state) => BlocProvider<ResetPasswordCubit>(
                ...
                create: (BuildContext context) => ResetPasswordCubit(resetAuthPassword: getIt.get()),
              ),
            ),
            GoRoute(
            ...
            GoRoute(
              ...
              builder: (BuildContext context, GoRouterState state) => BlocProvider<ApplicationCreateCubit>(
                create: (BuildContext context) => ApplicationCreateCubit(applicationCreateUsecase: getIt.get()),
            ...
            GoRoute(
              ...
              builder: (BuildContext context, GoRouterState state) =>
                  BlocProvider(create: (context) => CapabilitiesCubit(), child: const CapabilitiesScreen()),
            ),
            GoRoute(
            ...
            GoRoute(
              ...
              builder: (BuildContext context, GoRouterState state) => BlocProvider<TranslationsCubit>(
                create: (context) => TranslationsCubit(
                  ...
                  usecaseTranslationsGetActiveLocales: getIt.get(),
                  usecaseTranslationsSaveActiveLocales: getIt.get(),
                ),
