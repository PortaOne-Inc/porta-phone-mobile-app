...
class WidgetConfigRepositoryImpl extends WidgetConfigRepository {
  WidgetConfigRepositoryImpl({required this.configuratorBackendDatasource, required this.widgetConfigMapper});
  ...
  @override
  Future<WidgetsConfig> getByThemeVariant(String applicationId, String themeId, BrightnessVariant variant) =>
      guardApiCall(() async {
  ...
  @override
  Future<List<WidgetsConfig>> listForTheme(String applicationId, String themeId) => guardApiCall(() async {
  ...
  @override
  Future<Map<String, WidgetsConfig>> ensurePair(String applicationId, String themeId) => guardApiCall(() async {
