...
@injectable
class PlatformParamsMapper extends CommonMapper<d.PlatformParamsModel, PlatformParamsDto> {
  ...
  PlatformParamsDto convertTo(d.PlatformParamsModel it) => PlatformParamsDto(
        androidLegacy: it.androidLegacy != null ? slice.convertTo(it.androidLegacy!) : null,
        androidAdaptive: it.androidAdaptive != null ? slice.convertTo(it.androidAdaptive!) : null,
        ios: it.ios != null ? slice.convertTo(it.ios!) : null,
        web: it.web != null ? slice.convertTo(it.web!) : null,
      );

  @override
  d.PlatformParamsModel convertFrom(PlatformParamsDto it) => d.PlatformParamsModel(
        androidLegacy: it.androidLegacy != null ? slice.convertFrom(it.androidLegacy!) : null,
        androidAdaptive: it.androidAdaptive != null ? slice.convertFrom(it.androidAdaptive!) : null,
...
@injectable
class SourceConfigMapper extends CommonMapper<d.SourceConfigModel, SourceConfigDto> {
  @override
...
@injectable
class OutputArtifactsMapper extends CommonMapper<d.OutputArtifactsModel, OutputArtifactsDto> {
  @override
  ...
  @override
  d.OutputArtifactsModel convertFrom(OutputArtifactsDto it) => d.OutputArtifactsModel(
        androidLegacyArtifactId: it.androidLegacyArtifactId,
        androidAdaptiveForegroundArtifactId: it.androidAdaptiveForegroundArtifactId,
        androidAdaptiveBackgroundArtifactId: it.androidAdaptiveBackgroundArtifactId,
        iosArtifactId: it.iosArtifactId,
...
@injectable
class LaunchAssetsMapper extends CommonMapper<d.LaunchAssetsModel, LaunchAssetsDto> {
  ...
  LaunchAssetsDto convertTo(d.LaunchAssetsModel it) => LaunchAssetsDto(
        ...
        outputsArtifacts: it.outputsArtifacts != null ? outputsArtifacts.convertTo(it.outputsArtifacts!) : null,
  ...
  d.LaunchAssetsModel convertFrom(LaunchAssetsDto it) => d.LaunchAssetsModel(
        ...
        outputsArtifacts: it.outputsArtifacts != null ? outputsArtifacts.convertFrom(it.outputsArtifacts!) : null,
...
@injectable
class ValidationSliceMapper extends CommonMapper<d.ValidationSlice, ValidationSliceDto> {
  @override
  ValidationSliceDto convertTo(d.ValidationSlice it) =>
      ValidationSliceDto(compliant: it.compliant, deltaDp: it.deltaDp, message: it.message);

  @override
  d.ValidationSlice convertFrom(ValidationSliceDto it) =>
      d.ValidationSlice(compliant: it.compliant, deltaDp: it.deltaDp, message: it.message);
}

@injectable
class ValidationReportMapper extends CommonMapper<d.ValidationReport, ValidationReportDto> {
...
@injectable
class LaunchAssetsEnvelopeMapper extends CommonMapper<d.LaunchAssetsEnvelope, LaunchAssetsEnvelopeDto> {
  ...
  @override
  LaunchAssetsEnvelopeDto convertTo(d.LaunchAssetsEnvelope it) => LaunchAssetsEnvelopeDto(
        entity: entity.convertTo(it.entity),
        urls: it.urls,
        validation: it.validation != null ? validation.convertTo(it.validation!) : null,
      );

  @override
  d.LaunchAssetsEnvelope convertFrom(LaunchAssetsEnvelopeDto it) => d.LaunchAssetsEnvelope(
        entity: entity.convertFrom(it.entity),
        urls: it.urls,
        validation: it.validation != null ? validation.convertFrom(it.validation!) : null,
      );
}
