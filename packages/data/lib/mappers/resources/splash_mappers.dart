...
class SplashAssetParamsMapper extends CommonMapper<SplashAssetParams, SplashAssetParamsDto> {
...
@Injectable(as: CommonMapper<SplashConstraintsValidation, SplashConstraintsValidationDto>)
class SplashConstraintsValidationMapper
    extends CommonMapper<SplashConstraintsValidation, SplashConstraintsValidationDto> {
  @override
  SplashConstraintsValidationDto convertTo(SplashConstraintsValidation it) => SplashConstraintsValidationDto(
  ...
  @override
  SplashConstraintsValidation convertFrom(SplashConstraintsValidationDto it) => SplashConstraintsValidation(
        compliant: it.compliant,
        delta: it.deltaDp,
        message: it.message,
...
class SplashIconConstraintsMapper extends CommonMapper<SplashIconConstraints, SplashIconConstraintsDto> {
  SplashIconConstraintsMapper(this._valMapper);

  final CommonMapper<SplashConstraintsValidation, SplashConstraintsValidationDto> _valMapper;

  SplashMode _fromDtoMode(SplashModeDto v) =>
      v == SplashModeDto.withoutBackground ? SplashMode.withoutBackground : SplashMode.withBackground;

  SplashModeDto _toDtoMode(SplashMode v) =>
      v == SplashMode.withoutBackground ? SplashModeDto.withoutBackground : SplashModeDto.withBackground;

  @override
  SplashIconConstraintsDto convertTo(SplashIconConstraints it) => SplashIconConstraintsDto(
        mode: it.mode != null ? _toDtoMode(it.mode!) : SplashModeDto.withBackground,
  ...
  @override
  SplashIconConstraints convertFrom(SplashIconConstraintsDto it) => SplashIconConstraints(
        mode: _fromDtoMode(it.mode),
        fullSize: it.fullSizeDp,
        maskDiameter: it.maskDiameterDp,
        recommendedPadding: it.recommendedPaddingDp,
        recommendationBasis: it.recommendationBasis.isNotEmpty ? it.recommendationBasis : null,
...
class SplashAssetMapper extends CommonMapper<SplashAssetModel, SplashAssetDto> {
  ...
  final CommonMapper<SplashIconConstraints, SplashIconConstraintsDto> _constraints;
  ...
  SplashAssetDto convertTo(SplashAssetModel it) => SplashAssetDto(
        ...
        iconConstraints: it.iconConstraints != null ? _constraints.convertTo(it.iconConstraints!) : null,
  ...
  SplashAssetModel convertFrom(SplashAssetDto it) => SplashAssetModel(
        ...
        iconConstraints: it.iconConstraints != null ? _constraints.convertFrom(it.iconConstraints!) : null,
        createdAt: it.createdAt ?? '',
        updatedAt: it.updatedAt ?? '',
      );
}
