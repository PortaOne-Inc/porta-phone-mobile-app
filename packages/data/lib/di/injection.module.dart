...
import 'package:data/data/github_datasource.dart' as _i12;
import 'package:data/data/http_datasource.dart' as _i11;
import 'package:data/di/injection.dart' as _i17;
import 'package:data/repository/application_repository_impl.dart' as _i15;
import 'package:data/repository/auth_repository_impl.dart' as _i9;
import 'package:data/repository/deployment_repository_impl.dart' as _i14;
import 'package:data/repository/resources_repository_impl.dart' as _i8;
import 'package:data/repository/theme_repository_impl.dart' as _i16;
...
// initializes the registration of main-scope dependencies inside of GetIt
  ...
  _i2.FutureOr<void> init(_i1.GetItHelper gh) {
    ...
    gh.lazySingleton<_i12.GithubDatasource>(() =>
        _i12.GithubDatasource(gh<_i5.Dio>(instanceName: 'github_client')));
    gh.factory<_i13.DeploymentRepository>(() => _i14.DeploymentRepositoryImpl(
        githubDatasource: gh<_i10.GithubDatasource>()));
    gh.factory<_i7.ApplicationRepository>(() => _i15.ApplicationRepositoryImpl(
        httpDatasource: gh<_i10.HttpDatasource>()));
    gh.factory<_i7.ThemeRepository>(() =>
        _i16.ThemeRepositoryImpl(httpDatasource: gh<_i11.HttpDatasource>()));
  }
}
