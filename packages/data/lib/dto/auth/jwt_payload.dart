...
class JwtPayload with _$JwtPayload {
  factory JwtPayload({
    ...
    @JsonKey(name: 'auth_time') @TimestampConverter() required DateTime authTime,
    // ignore: invalid_annotation_target
...
class JwtPayloadFirebase with _$JwtPayloadFirebase {
  ...
  factory JwtPayloadFirebase.fromJson(Map<String, dynamic> json) => _$JwtPayloadFirebaseFromJson(json);
}
