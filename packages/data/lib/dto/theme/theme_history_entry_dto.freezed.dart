...
@override
String toString() {
  return 'ThemeHistoryEntryDto(id: $id, themeId: $themeId, applicationId: $applicationId, snapshotVersion: $snapshotVersion, action: $action, createdAt: $createdAt, changedBy: $changedBy, snapshot: $snapshot)';
}
...
class _ThemeHistoryEntryDto implements ThemeHistoryEntryDto {
  const _ThemeHistoryEntryDto({required this.id, required this.themeId, required this.applicationId, required this.snapshotVersion, required this.action, required this.createdAt, this.changedBy, final  Map<String, dynamic>? snapshot}): _snapshot = snapshot;
