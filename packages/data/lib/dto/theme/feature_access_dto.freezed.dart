...
mixin _$FeatureAccessDto {
 ...
 String get applicationId; String get status; Map<String, dynamic> get config; String? get themeId; String? get createdAt; String? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,applicationId,status,const DeepCollectionEquality().hash(config),themeId,createdAt,updatedAt);
...
@useResult
$Res call({
 String applicationId, String status, Map<String, dynamic> config, String? themeId, String? createdAt, String? updatedAt
});
...
/// Create a copy of FeatureAccessDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? applicationId = null,Object? status = null,Object? config = null,Object? themeId = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String applicationId,  String status,  Map<String, dynamic> config,  String? themeId,  String? createdAt,  String? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FeatureAccessDto() when $default != null:
return $default(_that.applicationId,_that.status,_that.config,_that.themeId,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String applicationId,  String status,  Map<String, dynamic> config,  String? themeId,  String? createdAt,  String? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _FeatureAccessDto():
return $default(_that.applicationId,_that.status,_that.config,_that.themeId,_that.createdAt,_that.updatedAt);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String applicationId,  String status,  Map<String, dynamic> config,  String? themeId,  String? createdAt,  String? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _FeatureAccessDto() when $default != null:
return $default(_that.applicationId,_that.status,_that.config,_that.themeId,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _FeatureAccessDto implements FeatureAccessDto {
  const _FeatureAccessDto({required this.applicationId, required this.status, required final  Map<String, dynamic> config, this.themeId, this.createdAt, this.updatedAt}): _config = config;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,applicationId,status,const DeepCollectionEquality().hash(_config),themeId,createdAt,updatedAt);
...
/// Create a copy of FeatureAccessDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? applicationId = null,Object? status = null,Object? config = null,Object? themeId = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
