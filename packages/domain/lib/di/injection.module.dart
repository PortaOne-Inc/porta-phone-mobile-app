...
import 'package:domain/entity/mappers/themes/colors_mapper.dart' as _i9;
...
import 'package:domain/entity/mappers/themes/theme_mapper.dart' as _i21;
...
import 'package:domain/entity/models/theme/theme_model.dart' as _i24;
...
import 'package:domain/usecase/applications/application_create.dart' as _i39;
...
import 'package:domain/usecase/theme/usecase_set_theme_default.dart' as _i25;
...
import 'package:domain/usecase/theme/usecase_theme_get.dart' as _i36;
import 'package:domain/usecase/theme/usecase_theme_get_all.dart' as _i37;
import 'package:domain/usecase/theme/usecase_theme_get_template.dart' as _i20;
import 'package:domain/usecase/theme/usecase_theme_update.dart' as _i38;
...
// initializes the registration of main-scope dependencies inside of GetIt
  ...
  _i2.FutureOr<void> init(_i1.GetItHelper gh) {
    ...
    gh.factory<_i20.UsecaseThemeGetTemplate>(
    ...
    gh.factory<_i3.Mapper<_i4.ApplicationDTO, _i22.ApplicationModel>>(() =>
        _i23.ApplicationMapper(
            gh<_i3.Mapper<_i4.ThemeDTO?, _i24.ThemeModel?>>()));
    gh.factory<_i25.UseCaseSetThemeDefault>(
        () => _i25.UseCaseSetThemeDefaultImpl(
    ...
    gh.factory<_i27.UsecaseApplicationAddTheme>(
        () => _i27.UsecaseApplicationAddThemeImpl(
              gh<_i15.ApplicationRepository>(),
              gh<_i15.AuthRepository>(),
              gh<_i26.Mapper<_i4.ApplicationDTO, _i26.ApplicationModel>>(),
              gh<_i26.Mapper<_i4.ThemeDTO?, _i26.ThemeModel>>(),
            ));
    gh.factory<_i28.UsecaseApplicationDeleteTemplate>(
        () => _i28.UsecaseApplicationDeleteTemplateImpl(
              gh<_i15.ApplicationRepository>(),
              gh<_i15.AuthRepository>(),
              gh<_i26.Mapper<_i4.ApplicationDTO, _i26.ApplicationModel>>(),
            ));
    gh.factory<_i29.UsecaseApplicationEdit>(() =>
        _i29.UsecaseApplicationEditImpl(
    ...
    gh.factory<_i30.UsecaseApplicationGet>(() => _i30.UsecaseApplicationGetImpl(
          applicationRepository: gh<_i15.ApplicationRepository>(),
          authRepository: gh<_i15.AuthRepository>(),
          mapper: gh<_i26.Mapper<_i4.ApplicationDTO, _i26.ApplicationModel>>(),
        ));
    gh.factory<_i31.UsecaseApplicationGetAll>(
        () => _i31.UsecaseApplicationGetAllImpl(
              gh<_i15.ApplicationRepository>(),
              gh<_i15.AuthRepository>(),
              gh<_i26.Mapper<_i4.ApplicationDTO, _i26.ApplicationModel>>(),
            ));
    gh.factory<_i32.UsecaseApplicationIncVersion>(
        () => _i32.UsecaseApplicationIncVersionImpl(
              gh<_i15.ApplicationRepository>(),
              gh<_i26.Mapper<_i4.ApplicationDTO, _i26.ApplicationModel>>(),
            ));
    ...
    gh.factory<_i36.UsecaseThemeGet>(
      () => _i36.UsecaseThemeStaticGetImpl(
    ...
    gh.factoryParam<_i36.UsecaseThemeGet, String, String>(
      (
        applicationId,
        themeId,
      ) =>
          _i36.UsecaseThemeGetImpl(
        themeRepository: gh<_i15.ThemeRepository>(),
        authRepository: gh<_i15.AuthRepository>(),
        mapper: gh<_i26.Mapper<_i4.ThemeDTO?, _i26.ThemeModel?>>(),
    ...
    gh.factory<_i37.UsecaseThemeGetAll>(() => _i37.UsecaseThemeGetAllImpl(
          themeRepository: gh<_i15.ThemeRepository>(),
          authRepository: gh<_i15.AuthRepository>(),
          mapper: gh<_i26.Mapper<_i4.ThemeDTO?, _i26.ThemeModel?>>(),
        ));
