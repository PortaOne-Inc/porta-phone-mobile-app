...
@override
String toString() {
  return 'ColorSchemeModel(applicationId: $applicationId, themeId: $themeId, variant: $variant, config: $config, id: $id, version: $version, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
class _ColorSchemeModel implements ColorSchemeModel {
  const _ColorSchemeModel({required this.applicationId, required this.themeId, required this.variant, required final  Map<String, dynamic> config, this.id, this.version, this.createdAt, this.updatedAt}): _config = config;
