...
mixin _$ThemeHistoryEntryModel {
 ...
 String get id; String get themeId; String get applicationId; int get snapshotVersion; String get action; String get createdAt; String? get changedBy; Map<String, dynamic>? get snapshot;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ThemeHistoryEntryModel&&(identical(other.id, id) || other.id == id)&&(identical(other.themeId, themeId) || other.themeId == themeId)&&(identical(other.applicationId, applicationId) || other.applicationId == applicationId)&&(identical(other.snapshotVersion, snapshotVersion) || other.snapshotVersion == snapshotVersion)&&(identical(other.action, action) || other.action == action)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.changedBy, changedBy) || other.changedBy == changedBy)&&const DeepCollectionEquality().equals(other.snapshot, snapshot));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,themeId,applicationId,snapshotVersion,action,createdAt,changedBy,const DeepCollectionEquality().hash(snapshot));

@override
String toString() {
  return 'ThemeHistoryEntryModel(id: $id, themeId: $themeId, applicationId: $applicationId, snapshotVersion: $snapshotVersion, action: $action, createdAt: $createdAt, changedBy: $changedBy, snapshot: $snapshot)';
}
...
@useResult
$Res call({
 String id, String themeId, String applicationId, int snapshotVersion, String action, String createdAt, String? changedBy, Map<String, dynamic>? snapshot
});
...
/// Create a copy of ThemeHistoryEntryModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? themeId = null,Object? applicationId = null,Object? snapshotVersion = null,Object? action = null,Object? createdAt = null,Object? changedBy = freezed,Object? snapshot = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String themeId,  String applicationId,  int snapshotVersion,  String action,  String createdAt,  String? changedBy,  Map<String, dynamic>? snapshot)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ThemeHistoryEntryModel() when $default != null:
return $default(_that.id,_that.themeId,_that.applicationId,_that.snapshotVersion,_that.action,_that.createdAt,_that.changedBy,_that.snapshot);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String themeId,  String applicationId,  int snapshotVersion,  String action,  String createdAt,  String? changedBy,  Map<String, dynamic>? snapshot)  $default,) {final _that = this;
switch (_that) {
case _ThemeHistoryEntryModel():
return $default(_that.id,_that.themeId,_that.applicationId,_that.snapshotVersion,_that.action,_that.createdAt,_that.changedBy,_that.snapshot);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String themeId,  String applicationId,  int snapshotVersion,  String action,  String createdAt,  String? changedBy,  Map<String, dynamic>? snapshot)?  $default,) {final _that = this;
switch (_that) {
case _ThemeHistoryEntryModel() when $default != null:
return $default(_that.id,_that.themeId,_that.applicationId,_that.snapshotVersion,_that.action,_that.createdAt,_that.changedBy,_that.snapshot);case _:
  return null;
...
class _ThemeHistoryEntryModel implements ThemeHistoryEntryModel {
  const _ThemeHistoryEntryModel({required this.id, required this.themeId, required this.applicationId, required this.snapshotVersion, required this.action, required this.createdAt, this.changedBy, final  Map<String, dynamic>? snapshot}): _snapshot = snapshot;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ThemeHistoryEntryModel&&(identical(other.id, id) || other.id == id)&&(identical(other.themeId, themeId) || other.themeId == themeId)&&(identical(other.applicationId, applicationId) || other.applicationId == applicationId)&&(identical(other.snapshotVersion, snapshotVersion) || other.snapshotVersion == snapshotVersion)&&(identical(other.action, action) || other.action == action)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.changedBy, changedBy) || other.changedBy == changedBy)&&const DeepCollectionEquality().equals(other._snapshot, _snapshot));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,themeId,applicationId,snapshotVersion,action,createdAt,changedBy,const DeepCollectionEquality().hash(_snapshot));
...
/// Create a copy of ThemeHistoryEntryModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? themeId = null,Object? applicationId = null,Object? snapshotVersion = null,Object? action = null,Object? createdAt = null,Object? changedBy = freezed,Object? snapshot = freezed,}) {
