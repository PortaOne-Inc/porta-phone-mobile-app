...
export class ThemeSharesController {
  ...
  @ApiBody({ type: CreateShareTokenDto, description: 'Application and theme to share' })
  ...
  @ApiResponse({ status: 200, description: 'Aggregated theme data with all sub-configs' })
  @ApiResponse({ status: 404, description: 'Share token not found or inactive' })
